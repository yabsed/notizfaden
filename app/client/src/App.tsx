...
export default function App() {
  ...
  return <div className={`app ${sidebar ? 'sidebar-open' : 'sidebar-closed'}`}>
    <header className="topbar"><div className="brand-area"><IconButton label="메뉴" onClick={() => setSidebar(!sidebar)}><Menu size={23}/></IconButton><a href="/" className="brand" onClick={e => { e.preventDefault(); navigate('notes'); }}><img className="brand-icon" src="/icon.svg" alt=""/><span className="brand-name">Notizfaden</span></a></div>
